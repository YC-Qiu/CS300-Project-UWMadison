...
/**
 * An iterator of class SongCollection (reverse order).
 * @author YC Qiu
 * @version 1.0
 * @since 2019-10-30
 */
public class ReversePlaylist implements Iterator<Song> {
	 ...
	 */
	public ReversePlaylist(DoublyLinkedNode<Song> LastSong) {
		// TODO Auto-generated constructor stub
		currentSong = LastSong;
		
		// A playlist plays the last song till the first one.
		FirstNode = true;
	}
	...
	public boolean hasNext() {
		...
		return (currentSong.getPrevious() != null); 
	...
	public Song next() {
		...
		else currentSong = currentSong.getPrevious();
